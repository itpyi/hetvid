...
#show: hetvid.with(
  ...
  author: (
    ...
    (
      name: "Bob",
      affiliation: ([Institute B], [Institute C]),
      email: "bob@b.edu",
    ),
    (
      name: "Charlie",
    ...
    (name: "itpyi", affiliation: ([Xijing Ci'en Institute of Translation, Tang Empire],), email: "itpyi@example.com"),
  ),
  header: "Instruction",
...
#show: hetvid.with(
  ...
  ind: 1.5em,
  justify: true,
  hyphenate: true, // if justify is false, this will make a difference
...
If all authors share a single unique affiliation, no superscripts are shown and the affiliation is displayed without numbering.
...
This renders the title block as:
...
#block(
  ...
  *A Multi-Author Paper*
  ...
  Alice#super[1,2], Bob#super[2,3], Charlie#super[1]

  #super[1]Institute A #h(1em) #super[2]Institute B #h(1em) #super[3]Institute C
]

The single-author syntax from previous versions remains fully supported:
```typ
#show: hetvid.with(
